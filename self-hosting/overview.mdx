...
Everything else — image generation, web search, semantic search, and Cloudflare R2 file storage — is optional, bring-your-own-key, and configured after boot in **Settings → Providers**. See [Providers](/self-hosting/providers).
...
<Columns cols={2}>
  ...
  <Card title="Providers" href="/self-hosting/providers">
    Set up the AI model, image generation, search, and storage.
  </Card>

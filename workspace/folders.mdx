...
<Steps>
  <Step title="Open the New Folder dialog">
    Click **New folder** from the **+** button, or open the **…** menu on any sidebar folder and choose **New subfolder** to create one inside it.
  </Step>
  <Step title="Name it and pick a location">
    Enter a **Folder name** and choose where it lives with the **in** picker — select **Workspace** to make it a top-level folder, or any existing folder to nest it.
  </Step>
</Steps>

You can also add folders from **Settings → Manage folders** with the **Add Folder** button.
